...
#+caption: MPD cover art notification
[[./assets/img/mpd-coverart-2025-05-16_20-38.png][file:./assets/img/mpd-coverart-2025-05-16_20-38.png]]
*** Directories
**** NCMPCPP Directory
...
#+end_src
**** Music Visualizer
#+caption: ncmpcpp visualizer
[[./assets/img/mpd-visualizer-2025-05-16_20-40.png][file:./assets/img/mpd-visualizer-2025-05-16_20-40.png]]
...
:LOGBOOK:
- State "TODO"       from              [2025-06-28 Sat 00:02]
:END:
#+begin_src conf
  def_key "ctrl-s"
...
#+begin_src shell :shebang #!/bin/sh
  ...
  notify-send -a ncmpcpp -r 27072 "$(playerctl metadata --all-players --format '{{title}}')" "<span color='#fdf6e3'>$(playerctl metadata --all-players --format '{{artist}}')</span>\n<span color='#268bd2'>$(playerctl metadata --all-players --format '{{album}}')</span>" -i "${cover}"
#+end_src
